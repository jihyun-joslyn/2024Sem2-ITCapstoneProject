...
import LocationOnIcon from '@mui/icons-material/LocationOn'; // 使用Material-UI的图标
  ...
  const handleChange = (event: React.SyntheticEvent, newValue: number) => {
    ...
    switch (newValue) {
      ...
      case 5:
        ...
        break;
      case 6:
        setTool('vertexSelect'); // 新增：顶点选择工具
        break;
      default:
        setTool('none');
    }
  ...
  return (
    <div id="side">
      ...
      >
        ...
        <Tab icon={<LocationOnIcon sx={{ color: '#9c806c' }} />} /> {/* 新增：顶点选择工具图标 */}
      </Tabs>
      {showColorSelector && (

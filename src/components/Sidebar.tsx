...
export default function Sidebar({ showFilePane, stlFiles, onFileSelect }: SidebarProps) {
    ...
    return (
        <div id="side">
          <Tabs
            ...
            id="toolbar"
          >
            <Tab icon={<FolderIcon sx={{ color: '#9c806c' }} />} aria-label="Folder" onClick={() => { setOpen(!open); showFilePane(!open); }} />
            <Tab icon={<ArrowIcon />} />

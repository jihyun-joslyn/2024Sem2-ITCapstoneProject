...
import { Folder as FolderIcon, PanTool as PanToolIcon, Brush as BrushIcon, LocationSearching as KeypointIcon, Timeline as TimelineIcon } from '@mui/icons-material';
  ...
  return (
    ...
    <div id="side">
      ...
      >
        ...
        <Tab icon={<TimelineIcon sx={{ color: '#9c806c' }} />} onClick={() => { setTool('path') }} />

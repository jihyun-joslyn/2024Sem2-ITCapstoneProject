...
export default function Problem({ problemName, labelArr, problemKey, updateProblem, deleteProblem, updateLabel }: ProblemProps) {
    ...
    const {states,modelId,problems,updateProblems, deleteProblem: storeDeleteProblem,addProblem,setCurrentProblemIndex} = useModelStore();
    ...
    },[isEditProblem,problem,labels,problemKey,updateProblems,states]);
